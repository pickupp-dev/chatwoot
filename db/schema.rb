...
ActiveRecord::Schema[7.0].define(version: 2025_03_10_045802) do
  ...
  create_table "webhooks", force: :cascade do |t|
    ...
    t.jsonb "subscriptions", default: ["conversation_status_changed", "conversation_updated", "conversation_created", "contact_created", "contact_updated", "message_created", "message_updated", "webwidget_triggered", "note_created"]
